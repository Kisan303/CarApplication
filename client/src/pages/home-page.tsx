    ...
    <div className="flex flex-col h-screen bg-[#121212]">
      ...
      <header className="flex justify-between items-center p-4 bg-[#000000] border-b border-gray-700">
        <div className="flex-1 flex justify-center items-center space-x-12">
          ...
          <div className="p-2">
            <svg
              className="h-8 w-8 text-white hover:text-gray-300 transition-colors"
              viewBox="0 0 384 512"
              fill="currentColor"
            >
          ...
          <div className="p-2">
            <svg
              className="h-8 w-8 text-blue-500 hover:text-blue-400 transition-colors"
              viewBox="0 0 24 24"
              fill="currentColor"
            >
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-64 bg-[#121212] border-r border-gray-800 flex flex-col overflow-hidden">
          ...
          <div className="p-3 text-sm font-medium text-slate-700">
            Your Playlists
          </div>
        ...
        <div className="w-72 border-l border-gray-800 flex flex-col overflow-hidden bg-[#121212]">
          <div className="p-4 bg-[#181818]">
            ...
            <p className="text-xs text-gray-400">
              Based on what's in your playlists
            </p>
          </div>
              ...
              {isLoadingRecommendations ? (
                Array(5)
                  ...
                  .map((_, i) => (
                    <div
                      key={i}
                      className="h-14 rounded-md bg-gray-800 animate-pulse"
                    />
                  ))
          ...
          {currentTrack && (
            <div className="w-full max-w-md flex items-center space-x-2 mt-1">
              <span className="text-xs text-slate-500">
                {formatDuration(
                  (currentTrack.duration * playbackProgress) / 100,
                )}
              </span>
