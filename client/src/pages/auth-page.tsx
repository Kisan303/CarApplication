  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="md:w-1/2 relative overflow-hidden">
        <div className={`absolute inset-0 flex items-center justify-center p-6 ${isLogin ? 'bg-blue-50' : 'bg-purple-50'}`}>
          {isLogin ? (
            <img 
              ...
              alt="Vintage blue car in snow with luggage" 
              className="object-cover rounded-xl shadow-lg max-w-full max-h-full" 
            />
          ) : (
            <img 
              src="https://images.unsplash.com/photo-1461360228754-6e81c478b882?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1548&q=80" 
              alt="Colorful vinyl records on a turntable" 
              className="object-cover rounded-xl shadow-lg max-w-full max-h-full" 
            />
          )}
        </div>
